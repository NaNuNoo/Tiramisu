# # # # # # # # # # # # # # # # # # # #
# File: Tiramisu/_TiramisuGL/enum.coffee
# Author: NaNuNo
...
tiGL.TextureFormat = TextureFormat
tiGL.TextureWrap = TextureWrap
tiGL.TextureFilter = TextureFilter
tiGL.SurfaceFormat = SurfaceFormat
tiGL.BufferUsage = BufferUsage
tiGL.IndexType = IndexType
tiGL.DrawMode = DrawMode
tiGL.GLSLType = GLSLType
tiGL.GLSLVar = GLSLVar
