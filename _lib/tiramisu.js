...
(function() {
  var BufferUsage, DrawMode, DynamicIndex, DynamicVertex, GLSLType, GLSLVar, IndexType, StaticMesh, StaticShader, StaticTexture2D, StaticTextureCube, SurfaceFormat, TextureFilter, TextureFormat, TextureWrap, bindAttributeBuffer, bindAttributeConst, bindCancelAnime, bindRequestAnime, bindUniform, canvas, canvasArray, createTexture2DHelper, createTextureCubeHelper, decodeObjFile, delayTime, glState, httpGetPromise, httpPostPromise, imagePromise, nextTick, onHttpError, onHttpLoad, onHttpTimeout, pramaGL, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, ti, updateAnime, webGL, winCancelAnime, winRequestAnime,
  ...
  updateAnime = function(func) {
    var handle, wrapFunc;
    handle = null;
    wrapFunc = function() {
      func();
      return handle = requestAnime(wrapFunc);
    };
  ...
  StaticShader.create_VsFs = function(vsCode, fsCode) {
    return new Promise(function(resolve, reject) {
      var hFragment, hShader, hVertex, i, idx, info, infoLog, isOk, j, location, ref11, ref12, shader;
      isOk = false;
      while (true) {
